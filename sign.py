...
def signYaohuo():
    ...
    session.set_field_value("[name=logname]", "18940918305")
    session.set_field_value("[name=logpass]", "82809391996")
...
def signNeu6():
    ...
    session.set_field_value("[name=username]", "670932228@qq.com")
    session.set_field_value("[name=password]", "82809391996")
